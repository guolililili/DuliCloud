                                        ...
                                        <form class="form-horizontal" action="#">
                                            ...
                                            <div class="form-group m-b-20 row">
                                                <div class="col-12">
                                                    ...
                                                    <input class="form-control" type="email" id="emailaddress" required="" placeholder="用户名">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row m-b-20">
                                                <div class="col-12">
                                                    ...
                                                    <input class="form-control" type="password" required="" id="password" placeholder="密码">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row text-center m-t-10">
                                                <div class="col-12">
                                                    <button class="btn btn-md btn-block btn-primary waves-effect waves-light" type="submit">登陆</button>
                                                </div>
                                            </div>
